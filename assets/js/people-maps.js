    ...
    visibleItemsArray.push(
        '<li>'+
            '<div class="item" id="' + json.data[a].id + '">' +
                ...
                '<div class="col-sm-10">' +
                    '<div class="row">' +
                        '<span class="title">' + json.data[a].name + '</span>' +
                        '<span class="designation">' + json.data[a].designation + '</span><span class="location"> @ ' + json.data[a].company + '</span><br>' +
                        '<span class="required-exp"><b>Experience: </b>' + json.data[a].experience + '</span>' +
                        '<span class="required-edu"><b>Education: </b>' + json.data[a].education + '</span>' +
                        '<span class="employment"><b>Industry: </b>' + json.data[a].industry + '</span>' +
                    '</div>' +
                '</div>' +
                '<div class="col-sm-12">' +
                    '<div class="row">' +
                ...
                '<div class="col-sm-5 col-sm-offset-2">' +
                        '<span class="social-activity"><b>Contacts</b>: 5 &nbsp;&nbsp;&nbsp; <b>You Know</b>: 5 &nbsp;</span>' +
                '</div>' +
